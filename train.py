# 대부분의 코드는 아래 예제에서 수정되었음.
# https://github.com/ml-explore/mlx-examples/blob/main/cifar/main.py
...
def main(args):
    ...
    model = get_vit_tiny(
            ...
            dropout_rate=0.1, depth=12, num_classes=10)
    print(model)
    print_zero(world, f"Number of params: {model.get_params_info() / 1e6:0.04f} M")
